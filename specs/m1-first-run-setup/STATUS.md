...
- **Moonraker:** #27 (on `master`, standalone) → MR-1 #22 → MR-9 #23 → MR-2 #24 → MR-4 #26 (needs MR-2's clock). MR-7 #28 goes after #22. **#25 goes before any MuonOS PR that adds the routes it floors.**
...
| — | [#27](https://github.com/Muon-3D/Moonraker/pull/27) @ `6d069c7` (KAN-403) | Ready | EndpointId in identity. Land it first. |
...
| — | [#316](https://github.com/Muon-3D/MuonOS/pull/316) @ `0e292fb` (KAN-403) | Contracts red | Re-record the Aux contract. |
...
| FL-7 | [Fluidd#14](https://github.com/Muon-3D/Muon3D_Fluidd/pull/14) @ `d6d7970` | Matches the spec | |
...
| Spec | [OrcaSlicer#5](https://github.com/Muon-3D/OrcaSlicer/pull/5) | Merged into the spec | KAN-399 `app` driver kind and KAN-400 rule S12. |
