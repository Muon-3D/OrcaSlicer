...
public:
    ...
    void load(const GCodeProcessorResult& gcode_result, const Print& print, const BuildVolume& build_volume,
            ConfigOptionMode mode, bool only_gcode = false);
...
private:
    void load_toolpaths(const GCodeProcessorResult& gcode_result, const BuildVolume& build_volume, const std::vector<BedExcludeRegion>& exclusion_regions);
    //BBS: always load shell at preview
