...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "bed_exclude_area", "bed_exclude_area_3d", "bed_custom_texture", "bed_custom_model", "gcode_flavor",
...
inline t_config_option_keys deep_diff(const ConfigBase &config_this, const ConfigBase &config_other, bool strict = true)
{
    ...
    for (const t_config_option_key &opt_key : keys) {
        ...
        if (this_opt != nullptr && other_opt != nullptr && *this_opt != *other_opt)
        {
            ...
            if (opt_key == "printable_area" || opt_key == "bed_exclude_area" || opt_key == "bed_exclude_area_3d" || opt_key == "compatible_prints" || opt_key == "compatible_printers" || opt_key == "thumbnails" ||  opt_key == "wrapping_exclude_area" || opt_key == "slicing_pipeline_plugin") {
