...
static std::vector<std::string> s_Preset_print_options {
    ...
    "outer_wall_acceleration", "initial_layer_acceleration", "top_surface_acceleration", "default_acceleration", "skirt_type", "skirt_loops", "skirt_speed","min_skirt_length", "skirt_distance", "skirt_start_angle", "skirt_height","skirt_loops_after_first_layer", "draft_shield",
...
static std::vector<std::string> s_Preset_printer_options {
    "printer_technology",
    "printable_area", "bed_exclude_area", "bed_exclude_area_3d", "bed_custom_texture", "bed_custom_model", "gcode_flavor",
...
inline t_config_option_keys deep_diff(const ConfigBase &config_this, const ConfigBase &config_other)
{
    ...
    for (const t_config_option_key &opt_key : config_this.keys()) {
        ...
        if (this_opt != nullptr && other_opt != nullptr && *this_opt != *other_opt)
        {
            ...
            if (opt_key == "printable_area" || opt_key == "bed_exclude_area" || opt_key == "bed_exclude_area_3d" || opt_key == "compatible_prints" || opt_key == "compatible_printers" || opt_key == "thumbnails") {
